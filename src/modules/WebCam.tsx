...
export default class Webcam extends React.Component<WebcamProps, WebcamState> {
  ...
  componentDidMount() {
    ...
    // if (props.autoStart) this.requestUserMedia()
  ...
  render() {
    ...
    const props: WebcamProps = this.props
    const props2: WebcamProps = Object.assign([], props).filter(
      (prop: any) => Object.keys(prop)[0] !== 'stop'
    )
